...
enum GRB_DoubleParam {
  ...
  GRB_DoubleParam_NLBarCFeasTol,
  GRB_DoubleParam_NLBarDFeasTol,
  GRB_DoubleParam_NLBarPFeasTol,
  GRB_DoubleParam_PDHGAbsTol,
  GRB_DoubleParam_PDHGConvTol,
  GRB_DoubleParam_PDHGIterLimit,
  GRB_DoubleParam_PDHGRelTol,
};
...
enum GRB_IntParam {
  ...
  GRB_IntParam_MasterKnapsackCuts,
  ...
  GRB_IntParam_InheritParams,
  GRB_IntParam_NoRelHeurSolutions,
  GRB_IntParam_FixVarsInIndicators,
  GRB_IntParam_NLBarIterLimit,
  GRB_IntParam_OptimalityTarget,
  GRB_IntParam_PDHGGPU,
  GRB_IntParam_ObjPassNumber
};
...
enum GRB_IntAttr {
  ...
  GRB_IntAttr_BarStatus,
  GRB_IntAttr_BarIterCount,
  GRB_IntAttr_NLBarIterCount,
  GRB_IntAttr_VBasis,
  GRB_IntAttr_CBasis,
  ...
  GRB_IntAttr_PoolNBoundVioIndex,
  GRB_IntAttr_PoolNConstrVioIndex,
  GRB_IntAttr_PoolNIntVioIndex,
  ...
  GRB_IntAttr_NumObjPasses,
  GRB_IntAttr_ObjNPass,
  GRB_IntAttr_ObjPassNStatus
};
...
enum GRB_DoubleAttr {
  ...
  GRB_DoubleAttr_PoolNMaxVio,
  GRB_DoubleAttr_PoolNBoundVio,
  GRB_DoubleAttr_PoolNBoundVioSum,
  GRB_DoubleAttr_PoolNConstrVio,
  GRB_DoubleAttr_PoolNConstrVioSum,
  GRB_DoubleAttr_PoolNIntVio,
  GRB_DoubleAttr_PoolNIntVioSum,
  ...
  GRB_DoubleAttr_ObjPassNIterCount,
  GRB_DoubleAttr_ObjPassNMIPGap,
  GRB_DoubleAttr_ObjPassNNodeCount,
  GRB_DoubleAttr_ObjPassNObjBound,
  GRB_DoubleAttr_ObjPassNObjVal,
  GRB_DoubleAttr_ObjPassNOpenNodeCount,
  GRB_DoubleAttr_ObjPassNRuntime,
  GRB_DoubleAttr_ObjPassNWork
};
...
class GRBModel
{
  private:
    ...
    unsigned int wheres;/* For which where flags should the callback be called */
  ...
  public:
    ...
    void setObjectiveN(GRBLinExpr obj, int index, int priority=0,
                       double weight=1, double abstol=1e-6, double reltol=0,
                       const char* name=0);
    ...
    double* get(GRB_DoubleAttr attr, const GRBGenConstr* xgenconstrs, int len);
    ...
    void set(GRB_IntAttr   attr, const GRBQConstr* xqconstrs,
             const int*   val, int len);
    void set(GRB_CharAttr   attr, const GRBQConstr* xqconstrs,
             const char*   val, int len);
    void set(GRB_DoubleAttr attr, const GRBQConstr* xqconstrs,
             const double* val, int len);
    void set(GRB_StringAttr attr, const GRBQConstr* xqconstrs,
             const std::string* val, int len);

    void set(GRB_IntAttr attr, const GRBGenConstr* xgenconstrs,
             const int* val, int len);
    void set(GRB_DoubleAttr attr, const GRBGenConstr* xgenconstrs,
             const double* val, int len);
    void set(GRB_StringAttr attr, const GRBGenConstr* xgenconstrs,
             const std::string* val, int len);

    /* By default, apply callback everywhere */
    void setCallback(GRBCallback* xcb, unsigned int wheres = ((unsigned int)(-1)));
};
