...
struct PlanningGrids_
{
  ...
  _resolution_type resolution;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _occupancy_data_type;
  _occupancy_data_type occupancy_data;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _distance_data_type;
  _distance_data_type distance_data;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _cost_data_type;
