...
get_filename_component(_filename "/workspaces/faster/ws/src/behavior_selector/srv/MissionModeChange.srv" NAME_WE)
add_custom_target(_behavior_selector_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "behavior_selector" "/workspaces/faster/ws/src/behavior_selector/srv/MissionModeChange.srv" ""
)
...
_generate_srv_cpp(behavior_selector
  "/workspaces/faster/ws/src/behavior_selector/srv/MissionModeChange.srv"
  "${MSG_I_FLAGS}"
  ""
